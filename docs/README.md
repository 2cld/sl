...
|---------------------|---------|-------------|-------------|-----|
| [HomeAssistant](http://192.168.0.10:8123/) | ha | - | - | na |
| [Homer](http://192.168.0.10:8123/) | app | - | - | na |
| sl proxmox vms |---------|-------------|-------------|-----|
| [192.168.0.119:9000](http://192.168.0.119:9000/)  | docker | vm sl-100 | sl | 08-00-27-84-49-45 |
